    ...
    if (cadastros.length === 0) {
        ...
        for (let dado of cadastros) {
            ...
            <tr>
                ...
                <td>${dado.data[0]}</td>
                <td>
                    <svg onclick="excluirCadastro(${cadastros.indexOf(dado)})" xmlns="http://www.w3.org/2000/svg" fill="currentColor" class="bi bi-trash-fill text-danger" viewBox="0 0 16 16">
